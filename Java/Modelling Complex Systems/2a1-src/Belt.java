/**
 * @author Kun Liu The baggage belt, super class of main belt and short belt
 */
public class Belt {
	...
	// when sense a suspicious bag, stop waiting
	...
	public synchronized Bag getSuspiciousBag() throws InterruptedException {
		...
		System.out.println("get suspicious bag done");
		notifyAll();
		return bag;
	}
